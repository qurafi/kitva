...
import { actions_validated } from "$schemas/routes/form/no-specific-schema/schemas";
...
export const createValidatedForm = defineGenerated<ActionsData["validated"]>("validated", "kitva-Kic", actions_validated, localize)