...
export async function setup(cwd: string) {
    ...
    if (tsconfig) {
        ...
        console.log(
            "⚠️: Could not add typescript rootDirs because tsconfig/jsconfig is missing"
        );
    }

    console.log("✅ Setup done, Make sure to install kitva package:");
    console.log("   'pnpm i kitva' or 'npm i kitva'");
}
